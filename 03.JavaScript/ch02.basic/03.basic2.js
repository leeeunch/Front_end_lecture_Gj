...
//증감 연산자
let b = 1;
console.log(a++, ++b);  //post increment, pre increment  //++연산자는 기본 변수 값에 1을 더함
console.log(a,b);
...
// 일치 연산자
console.log('1' == 1.0); // 숫자의 값이 같은지
console.log('1' === 1.0, 1 === 1.0); // 숫자 값과 자료형이 모두 같은가 //정수와 실수 차이는 맞다고 봄
console.log(1 === 1.0);
console.log(2 == 1.0);
